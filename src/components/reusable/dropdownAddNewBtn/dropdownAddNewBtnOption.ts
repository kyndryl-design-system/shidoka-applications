...
import DropdownOptionScss from './dropdownAddNewBtnOption.scss';
 ...
 */
@customElement('kyn-dropdown-addnew-btn-option')
export class DropdownAddNewBtnOption extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'kyn-dropdown-addnew-btn-option': DropdownAddNewBtnOption;
  }
}
