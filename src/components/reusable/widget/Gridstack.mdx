...
The widget-gridstack component includes [the Shidoka default config](https://github.com/kyndryl-design-system/shidoka-applications/blob/main/src/common/helpers/gridstack.ts#L1) automatically, but if it needs to be modified you can import the config separately and make adjustments. See the gridstack documentation for more information on the available options.
