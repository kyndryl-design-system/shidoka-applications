...
export const MoreClickUsesClickedCategoryRegression = {
  parameters: {
    a11y: {
      disable: true,
    },
...
MoreClickUsesClickedCategoryRegression.storyName =
  'Slotted More Regression: Truncated Root To Full Detail';
