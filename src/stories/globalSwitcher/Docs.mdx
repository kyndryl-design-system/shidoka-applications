...
| ----------------------- | --------------------- | ----------- | ----------------------------------------------------------------- |
| `kyn-header-nav`        | `flyoutAutoCollapsed` | `true`      | `false` keeps flyouts open on mouse leave                         |
| `kyn-header-nav`        | `defaultOpen`         | `'default'` | Which flyout to expand initially (matches `kyn-header-link` `id`) |
...
| `kyn-header-categories` | `layout`              | `'masonry'` | `'masonry'` or `'grid'`                                           |
| `kyn-header-categories` | `maxColumns`          | `3`         | Column cap for masonry/grid layout                                |
| `kyn-header-categories` | `maxRootLinks`        | `4`         | Links shown before "More" button                                  |
