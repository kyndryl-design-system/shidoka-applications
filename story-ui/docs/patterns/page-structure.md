...
5. For **fullscreen** stories, add a **decorator** in the story meta that wraps the story in a div with `margin: var(--kd-negative-page-gutter, -1rem); min-height: 100vh;` so the shell extends edge-to-edge.
...
const meta: Meta = {
  ...
  decorators: [
    (story) => html`
      <div
        style="margin: var(--kd-negative-page-gutter, -1rem); min-height: 100vh;"
      >
...
- `../../components/reusable/button/button`
