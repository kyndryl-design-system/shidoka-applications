...
`)}},go=o=>[Math.trunc(255*o.r),Math.trunc(255*o.g),Math.trunc(255*o.b)],Wn=o=>{let[e,t,r]=go(o);return"#"+((1<<24)+(e<<16)+(t<<8)+r).toString(16).slice(1)},Rt=({property:o,value:e})=>`${o}: ${e};`});var Zn,Bt,yo,Gn,Xn,bo,xo=w(()=>{d();p();h();D();Ot();vo();Zn=function(o,e,t,r){function n(i){return i instanceof t?i:new t(function(s){s(i)})}return new(t||(t=Promise))(function(i,s){function c(u){try{l(r.next(u))}catch(m){s(m)}}function a(u){try{l(r.throw(u))}catch(m){s(m)}}function l(u){u.done?i(u.value):n(u.value).then(c,a)}l((r=r.apply(o,e||[])).next())})},Bt=o=>Zn(void 0,void 0,void 0,function*(){yield navigator.clipboard.writeText(o)}),yo=({node:o,onClose:e})=>{if(!o)return null;let t=new We(o),r=n=>n.stopPropagation();return S`
    <div
  ...
  `},Gn=o=>{let e=()=>Bt(o.getStyleSheet()),t=o.getStyles();return S`<div class="inspector-section">
